...
?>
    ...
    <div class="row">
        <div class="col-md-5 col-sm-12 col-xs-12">
            <button id="btncate-box" class="btn btn-primary">CATEGORY</button>
                                    ...
                                    <div class="col-md-10 col-sm-12 col-xs-12 col-md-offset-1">
                                        <form class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="file-input">
                                                        <input type="file" id="edit_file1" name="edit_image1">
                                                        <span class="button">Choose</span>
                                                        <span class="label" style="font-size: 14px;font-weight: 500;padding: .2em 0em .3em;" data-js-label>No file selected</label>
                                                    </div>
                                                    <script>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="file-input">
                                                        <input type="file" id="edit_banner1" name="edit_banner1">
                                                        <span class="button">Choose</span>
                                                        <span class="label" style="font-size: 12px;font-weight: 500;padding: .2em 0em .3em;" data-js-label>No Banner selected</label>
                                                    </div>
                                                        <script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#show-table1').DataTable({
                "pageLength" : 5,
                "ajax": {
                    url : '<?= site_url("Authority/DataTable").'?flag=category'; ?>',
                    type : 'GET'
                },
            });
        });
		...
		$(document).ready(function() {
			$('#btnsubmit').click(function() {
				...
				$.ajax({
					...
					processData: false,
					contentType: false,
					url: "<?= site_url('Authority/code').'?flag=category'; ?>",
			...
			$('#btnsubcate').click(function() {
				...
				$.ajax({
					...
					processData: false,
					contentType: false,
					url: "<?= site_url('Authority/code').'?flag=service'; ?>",
					success: function(response){
						if (response == "success") {
							fire_toast("Subcategory added successfully.", "success");
							setTimeout(function() {
								location.reload();
							}, 1000);
						}
							...
							fire_toast("Not eligible.", "warning");
						}
					},
					error:function(){
						alert("Something went wrong.");
			...
			$('#updatecate').click(function() {
				...
				$.ajax({
					...
					processData: false,
					contentType: false,
					url: "<?= site_url('Authority/crud').'?flag=category'; ?>",
					success: function(response) {
						if (response == "success") {
			...
			$('#subupdate').click(function() {
				...
				$.ajax({
					...
					processData: false,
					contentType: false,
					url: "<?= site_url('Authority/crud').'?flag=service'; ?>",
					success: function(response) {
						if (response == "success") {
							fire_toast("Subcategory updated.", "success");
							setTimeout(function() {
								location.reload();
							}, 1000);
						}
    ...
    <script>
        function remove(e) {
            $.ajax({
                type: "POST",
                data: {id:e.id},
                url: '<?= site_url("Authority/crud")."?flag=remove-service"; ?>',
                success: function(response) {
                    if (response == "success") {
                        fire_toast("Subcategory Removed.", "success");
                        setTimeout(function() {
                            location.reload();
                        }, 1000);
                    }
        ...
        function remove1(e) {
            $.ajax({
                type: "POST",
                data: {id:e.id},
                url: '<?= site_url("Authority/crud")."?flag=remove-category"; ?>',
                success: function(response) {
                    if (response == "success") {
        ...
        function update(e) {
            $.ajax({
                type: "POST",
                data: {id:e.id},
                url: '<?= site_url("Authority/getData")."?flag=service"; ?>',
                success: function(response){
        ...
        function update1(e) {
            $.ajax({
                type: "POST",
                data: {id:e.id},
                url: '<?= site_url("Authority/getData")."?flag=category"; ?>',
                success: function(response) {
                    var obj = jQuery.parseJSON(response);
                    $('#edit_id1').val(obj.id);
